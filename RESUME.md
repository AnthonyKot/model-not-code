...
## Rework in progress — 2026-09-22: chapters, cross-check, site copy and appendices A–C done
...
the live site is unchanged until the next push. Every chapter now has its exercise in `labs/<slug>.md`. The cross-check of 8 against 1–7 is done
(chapter 7's bridge and chapter 8's answer-writer row repaired; see chapter 8's note). Site support for labs is in place:

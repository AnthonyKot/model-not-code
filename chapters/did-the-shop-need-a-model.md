...
**What flips it.** The rule's cost is its misses, 80 a month at a 25% dodge rate. For the rule's total to reach the classifier's 11,660, its misses would have to cost about 11,000, which is 550 missed blades a month, a dodge rate near 100%: no realistic dodge rate makes the classifier alone win. Against both, the flip is at about 5,100 of extra misses, about 255 blades, a dodge rate around 80%. Or the price of a miss: at 20 a miss the rule wins; at 150 a miss the rule's 80 misses cost 12,000 and both wins. The number the shop must name is the price of a blade sold without an age check, and the ledger cannot supply it.
